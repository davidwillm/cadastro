    								...
    								<div class="form-group col-md-5">
	 								...
	 								<div class="form-group col-md-5">
     									 <label for="inputname">Email</label>
      										<input type="email" class="form-control" name="email" id="inputname" placeholder="Email" required="required">
    								</div>
	 								...
	 								<div class="form-group col-md-3">
      									<label for="inputname">Senha</label>
      										<input type="password" class="form-control" name="senha" id="inputname" placeholder="Password" required="required">
    									</div>
    									<div class="form-group col-md-3">
    										<label for="inputname">Nível de Acessso</label>
    										<select class="custom-select" name="nivel" required="required">
